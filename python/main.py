...
class ImageLoader(UI,Ui_Dialog):
    def __init__(self,MainWindow):
        ...
        self.actionDocumentation.triggered.connect(self.openDoc_help)
        self.actionRepository.triggered.connect(self.openRepository)
        self.analysisResults={}

    def displayStatus(self,statusMessage):
        MainWindow.statusBar().showMessage(statusMessage)

    def openDoc_help(self):
        #app = QApplication(sys.argv)
        url = QUrl("https://github.com/ahmadhmirza/AD-VEDD/blob/master/README.md")
