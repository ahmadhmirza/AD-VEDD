...
class UI(object):
    def __init__(self, MainWindow):
        ...
        self.Analysis_result = QtWidgets.QTreeWidget(self.imageTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Analysis_result.sizePolicy().hasHeightForWidth())
        self.Analysis_result.setSizePolicy(sizePolicy)
        self.Analysis_result.setObjectName("Analysis_result")
        # item_0 = QtWidgets.QTreeWidgetItem(self.Analysis_result)
        # item_1 = QtWidgets.QTreeWidgetItem(item_0)
        # item_2 = QtWidgets.QTreeWidgetItem(item_1)
        # item_2 = QtWidgets.QTreeWidgetItem(item_1)
        # item_1 = QtWidgets.QTreeWidgetItem(item_0)
        self.Analysis_GridLayout.addWidget(self.Analysis_result, 1, 0, 1, 2)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1372, 39))
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.Analysis_result.headerItem().setText(0, _translate("MainWindow", "Name"))
        # self.Analysis_result.headerItem().setText(1, _translate("MainWindow", "value"))
        # __sortingEnabled = self.Analysis_result.isSortingEnabled()
        # self.Analysis_result.setSortingEnabled(False)
        # self.Analysis_result.topLevelItem(0).setText(0, _translate("MainWindow", "Vehicle"))
        # self.Analysis_result.topLevelItem(0).child(0).setText(0, _translate("MainWindow", "Box"))
        # self.Analysis_result.topLevelItem(0).child(0).setText(1, _translate("MainWindow", "1"))
        # self.Analysis_result.topLevelItem(0).child(0).child(0).setText(0, _translate("MainWindow", "X-min"))
        # self.Analysis_result.topLevelItem(0).child(0).child(1).setText(0, _translate("MainWindow", "Y-min"))
        # self.Analysis_result.topLevelItem(0).child(1).setText(0, _translate("MainWindow", "Calss"))
        # self.Analysis_result.topLevelItem(0).child(1).setText(1, _translate("MainWindow", "Car"))
        # self.Analysis_result.setSortingEnabled(__sortingEnabled)
